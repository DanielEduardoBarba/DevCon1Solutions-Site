...
export default function sitemap() {
  return [
    ...
    { url: `${BASE_URL}/markour/`,  lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.6 },
    { url: `${BASE_URL}/marksman/`, lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.6 },
